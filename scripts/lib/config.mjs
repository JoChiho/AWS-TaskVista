...
export const API_ROUTES = [
  ...
  { methods: ['GET', 'POST'], path: '/projects/{projectId}/tasks', lambda: 'taskvista-tasks' },
  {
    ...
    lambda: 'taskvista-tasks',
  },
  {
    methods: ['POST'],
    path: '/projects/{projectId}/wbs/renumber',
    lambda: 'taskvista-tasks',
  },
  ...
  { methods: ['POST'], path: '/tasks/{taskId}/children', lambda: 'taskvista-tasks' },
  { methods: ['POST'], path: '/tasks/{taskId}/move', lambda: 'taskvista-tasks' },
